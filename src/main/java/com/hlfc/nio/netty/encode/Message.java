package com.hlfc.nio.netty.encode;
...
public class Message {
	...
	public Message(String sessionId , String data) {

		Header header= null;
		try {
			header = new Header((byte)0, (byte)1, (byte)1, (byte)1, (byte)0, sessionId,data.getBytes("UTF-8").length, 1);
