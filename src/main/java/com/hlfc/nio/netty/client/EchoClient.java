package com.hlfc.nio.netty.client;
 

import com.hlfc.nio.netty.encode.Header;
import com.hlfc.nio.netty.encode.Message;
import com.hlfc.nio.netty.encode.MessageDecoder;
import com.hlfc.nio.netty.encode.MessageEncoder;
...
public final class EchoClient {
    ...
    private void  connect() throws Exception {
        ...
        try {
            ...
            //客户端像服务端发送消息
            Message message=new Message("713f17ca614361fb257dc6741332caf2","你好");
            p.writeAndFlush(message);
